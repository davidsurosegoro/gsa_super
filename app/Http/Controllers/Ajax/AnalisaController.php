...
class AnalisaController extends Controller
{
    ...
    public function map_data(Request $request)
    {
        ...
        return response()->json(array('is_allow' => $is_allow, 'type' => $map->type, 'data' => $map, 'view_summary' => $view_summary, 'is_exist_summary' => $is_exist_summary), 200);
    }
    ...
    public function added_item(Request $request)
    {
        ...
        return response()->json(array('map_data' => $map), 200);
    }
    ...
    public function modal_setting(Request $request)
    {
        ...
        return response()->json(array('html' => $view, 'attribut' => $view_attribut, 'map_data' => $map, 'attr_data' => $form_data), 200);
    }
    ...
    public function label_styling(Request $request)
    {
        ...
        return response()->json(array('view' => $view_attribut), 200);
    }
    ...
    public function query(Request $request)
    {
        ...
        return response()->json(array('res' => $res_fix, 'status' => $status, 'kecamatan' => $request->group_kecamatan));
    }
    ...
    public function cbo_categorized(Request $request)
    {
        ...
        return response()->json(array('view' => $view_table, 'view_label' => $view_label), 200);
    }
    ...
    public function categorized_layer(Request $request)
    {
        ...
        exec($cmd);
        $client->put('layers/bappeko:' . $request->map_name . '.json', [
            'headers' => [
                'Content-Type'   => 'application/json',
        ...
        return response()->json(array('view' => $view, 'sld' => $sld_file['name']), 200);
    }
