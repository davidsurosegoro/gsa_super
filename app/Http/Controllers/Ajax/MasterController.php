...
class MasterController extends Controller
{
    ...
    public function tag(Request $request)
    {
        ...
        return response()->json(array('skpd' => $skpd, 'view_table_tagged' => $view_table_tagged, 'view_cbo_tagged' => $view_cbo_tagged, 'id' => $request->id), 200);
    }
    ...
    public function update_attr(Request $request)
    {
        ...
        $client->post('workspaces/bappeko/datastores/bappeko_2019/featuretypes.json', [
            'headers' => [
    ...
    public function edit_peta(Request $request)
    {
        ...
        return response()->json(array("map" => $map, "projeksi" => $projeksi), 200);
    ...
    public function kelola(Request $request)
    {
        ...
        return response()->json(array('view' => $view_table, 'map_name' => $map_name, 'view_attribut_query' => $view_attribut_query, 'is_summary_exists' => $is_summary_exists, 'view_summary' => $view_summary, 'view_attribut_query_edit' => $view_attribut_query_edit), 200);
    }
}
