      ...
      <?php echo e(csrf_field()); ?>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="nama" class="form-control form-control-solid" placeholder="Inpur Nama Agen">
          ...
          <div class="form-group">
            ...
            <input type="text" name="kode" class="form-control form-control-solid" placeholder="Inpur Kode Agen">
    ...
    <form method="POST" action="<?php echo e(url('master/agen/update')); ?>">
      ...
      <?php echo e(csrf_field()); ?>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Nama Agen:</label>
            <input type="text" name="nama" id="nama" class="form-control form-control-solid" placeholder="Inpur Nama Agen">
            <span class="form-text text-muted">Silahkan masukan nama agen</span>
          </div>
          ...
          <div class="form-group">
            <label>Kode Agen:</label>
            <input type="text" id="kode" name="kode" class="form-control form-control-solid" placeholder="Inpur Kode Agen">
            <span class="form-text text-muted">Silahkan masukan kode agen</span>
          </div>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\awb\resources\views/pages/master/agen/index.blade.php ENDPATH**/ ?>