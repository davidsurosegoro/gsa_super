...
<html lang="en">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <script src="<?php echo e(asset('assets/js/map/default_layer.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/js/map/analisa.js')); ?>"></script>
    ...
    <!--end::Body-->
</html><?php /**PATH C:\xampp\htdocs\sigis_next\resources\views/layouts/analisa/app.blade.php ENDPATH**/ ?>